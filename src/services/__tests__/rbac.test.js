...
import { canManageAccount, scopeAccountsForUser, scopeEventsForUser, stripAccountPII, toPublicUser, } from "../rbac.js";
const makeAccount = (o = {}) => ({
    id: "acc1",
    customerName: "Acme",
    phone: "123",
...
describe("scopeAccountsForUser", () => {
    ...
    it("BANKER sees accounts that have an open auction they are eligible for", () => {
        ...
        const banker = { id: "b1", role: "BANKER", bankId: "bank1" };
...
function bankerView(accounts, banker, auctions) {
...
describe("BANKER account visibility — PII is never exposed", () => {
    ...
    it("BANKER sees no accounts when their bank is not in eligibleBankIds", () => {
        const otherBanker = { id: "b2", role: "BANKER", bankId: "bank99" };
