 ...
 */
export declare function runExpirySweep(deps: ExpirySweepDeps): Promise<number>;
/**
 ...
 */
export declare function startAuctionExpiryService(deps: ExpirySweepDeps, intervalMs?: number): {
    stop: () => void;
};
//# sourceMappingURL=auctionExpiryService.d.ts.map