 ...
 */
export declare function settleAuction(auction: AuctionOpportunity, offers: BankOffer[], deps: SettlementDeps, options?: SettleOptions, now?: number): Promise<AuctionOpportunity>;
//# sourceMappingURL=auctionSettlement.d.ts.map