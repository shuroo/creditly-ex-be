...
export type CrmTrigger = "status_changed" | "document_uploaded" | "auction_opened" | "winning_offer_selected";
...
export declare class CrmIntegration {
    /**
     ...
     */
    sync(request: CrmSyncRequest): Promise<CrmSyncResponse>;
}
/** Singleton CRM integration client used throughout the application. */
export declare const crmIntegration: CrmIntegration;
